declare
h1   NUMBER;
jobcount varchar2(6) :=1 ;
table_name VARCHAR2(100);
CURSOR table_names IS SELECT tablename FROM so46905.streams2 where tip = 'DML';
 begin
      FOR table_name IN table_names LOOP
  begin 
     h1 := dbms_datapump.open (operation => 'IMPORT', job_mode => 'TABLE', remote_link => 'RACAR.REGRESS.RDBMS.DEV.US.ORACLE.COM', job_name => 'JOB00'||jobcount, version => 'COMPATIBLE'); 
  end;
  begin 
