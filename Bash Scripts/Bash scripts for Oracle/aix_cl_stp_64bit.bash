...
echo "**********************************************************"
echo "ORACLE AIX CLIENT KURULUMU BASLIYOR..."
echo "**********************************************************"
...
su - oracle "-c whoami; /runInstaller -noconfig -waitforcompletion -responseFile ./client_install.rsp -silent -ignorePrereq -ignoreSysPrereqs"
